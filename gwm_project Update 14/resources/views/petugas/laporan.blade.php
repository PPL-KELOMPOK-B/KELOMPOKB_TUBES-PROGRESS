...
<body>
        ...
        <div class="profile-container">
            <div class="profile-top">
                ...
                <div class="profile-info">
                    <h4>Petugas</h4>
                    <p>{{ auth()->user()->name ?? 'Budi Santoso' }}</p>
                </div>
            </div>
    ...
    <main class="main-content">
        <div class="top-header">
            <div class="page-title">
                ...
                <p>
                    ...
                    Menampilkan laporan Kecamatan {{ explode(' ', auth()->user()->name)[1] ?? 'Purwosari' }}
                </p>
            </div>
            <a href="{{ route('petugas.create_laporan') }}" class="btn-add">
        ...
        <form method="GET" action="{{ route('petugas.laporan.index') }}" class="filter-section">
                    ...
                    <div class="report-card">
                        <div class="report-top">
                            <div class="report-badges">
                                ...
                                <span class="badge-level {{ $levelClass }}">{{ $level }}</span>
                            </div>
                        ...
                        <h3 class="report-title">Kelurahan {{ $lap->kelurahan }}</h3>
                        ...
                        <div class="report-location">
                            ...
                            Kec. {{ str_replace('Petugas ', '', $lap->kecamatan ?? (explode(' ', auth()->user()->name)[1] ?? 'Purwosari')) }}
                        </div>
                        ...
                        @if($lap->tindakLanjuts && $lap->tindakLanjuts->count() > 0)
                            @php $lastTl = $lap->tindakLanjuts->last(); @endphp
                            <div style="margin-top: 12px; padding: 12px 16px; background: #f0f9ff; border: 1px solid #e0f2fe; border-radius: 10px; font-size: 13px;">
                                <div style="display: flex; align-items: center; gap: 8px; font-weight: 700; color: #0369a1; margin-bottom: 6px;">
                                ...
                                <p style="color: #475569; margin: 0; line-height: 1.5; font-weight: 500;">
                                    {{ \Illuminate\Support\Str::limit($lastTl->deskripsi_aksi, 120) }}
                                </p>
                                <div style="margin-top: 6px; font-size: 11px; color: #94a3b8; font-weight: 500;">
                                    Diperbarui pada: {{ $lastTl->tanggal ? \Carbon\Carbon::parse($lastTl->tanggal)->format('d M Y') : '-' }}
                                </div>
                            </div>
                        @endif
