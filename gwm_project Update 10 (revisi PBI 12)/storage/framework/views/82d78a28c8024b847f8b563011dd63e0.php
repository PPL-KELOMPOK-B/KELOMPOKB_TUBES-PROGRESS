...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi_kekeringan" placeholder="1" required min="1" oninvalid="this.setCustomValidity('Durasi kekeringan harus lebih dari 0')" oninput="this.setCustomValidity('')" value="<?php echo e(old('durasi_kekeringan', $laporan->durasi_kekeringan ?? '')); ?>" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid <?php echo e($errors->has('durasi_kekeringan') ? '#ef4444' : '#cbd5e1'); ?>; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none;">
...
</html><?php /**PATH C:\laragon\www\gwm_project Update 8 LOGIN updated\resources\views/petugas/create_laporan.blade.php ENDPATH**/ ?>