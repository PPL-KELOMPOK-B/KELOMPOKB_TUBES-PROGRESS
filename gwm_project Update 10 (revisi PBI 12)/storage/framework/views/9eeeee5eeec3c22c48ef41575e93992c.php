    ...
    <div class="split-layout">
        ...
        <div class="right-side">
            <div class="login-container">
                ...
                <?php endif; ?>
                <?php if($errors->has('password') && !$errors->has('roleError')): ?>
                    <div
                        style="background: #fef2f2; color: #ef4444; border: 1px solid #fca5a5; padding: 12px; border-radius: 8px; margin-bottom: 20px; font-size: 14px; font-weight: 500; text-align: center;">
...
</html><?php /**PATH D:\kuliah sem 6\PPL\TUBES KELB\gwm_project Update 8\resources\views/welcome.blade.php ENDPATH**/ ?>