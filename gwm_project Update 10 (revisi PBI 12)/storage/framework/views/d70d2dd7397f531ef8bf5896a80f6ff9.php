    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e(($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($sedang ?? 0)); ?>,
                        <?php echo e(($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($tinggi ?? 0)); ?>,
                        <?php echo e(($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($kritis ?? 0)); ?>
...
</html><?php /**PATH C:\Users\Lenovo\gwm_project Update 9 (revisi PBI 1)\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>