    ...
    <main class="main-content">
        <div class="top-header">
            <div class="page-title">
                <h1>Dashboard</h1>
                <p>Selamat datang kembali, <?php echo e(auth()->user()->name ?? 'Budi Santoso'); ?></p>
            </div>
            <div class="top-pill">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                ...
                Kecamatan <?php echo e(auth()->user()->name ?? 'Purwosari'); ?>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-val"><?php echo e($total); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-val"><?php echo e($menunggu); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-val"><?php echo e($proses); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-val"><?php echo e($selesai); ?></span>
                </div>
        ...
        <div class="middle-grid">
            ...
            <div class="card">
                ...
                <div class="actions-list">
                    <a href="<?php echo e(route('petugas.create_laporan')); ?>" class="action-btn btn-primary">
                    ...
                    <a href="<?php echo e(route('petugas.draft')); ?>" class="action-btn btn-outline">
                        <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                        Lihat Draft Laporan
                    </a>
                    <a href="<?php echo e(route('petugas.laporan.index')); ?>" class="action-btn btn-outline">
                        <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                        Lihat Semua Laporan
                    </a>
                </div>
        ...
        <div class="card">
            <div class="card-header-between">
                ...
                <a href="<?php echo e(route('petugas.laporan.index')); ?>" class="link-all">Lihat Semua</a>
            </div>
                            ...
                            <div class="report-main">
                                <div class="report-top">
                                    ...
                                    <span class="badge-status 
                                        <?php if($lap->status == 'menunggu_validasi'): ?> status-menunggu
                                        <?php elseif($lap->status == 'diterima'): ?> status-diterima
                                        <?php elseif($lap->status == 'ditolak'): ?> status-ditolak
                                        <?php elseif($lap->status == 'proses'): ?> status-proses
                                        <?php elseif($lap->status == 'selesai'): ?> status-selesai
                                        <?php else: ?> status-menunggu <?php endif; ?>">
                                ...
                                <h4 class="report-title">Kelurahan <?php echo e($lap->kelurahan); ?></h4>
                                <p class="report-meta">
        ...
        new Chart(barCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?php echo e($proses + $selesai); ?>, <?php echo e($proses); ?>, <?php echo e($selesai); ?>],
...
</html><?php /**PATH C:\Users\Lenovo\gwm_project Update 9 (revisi PBI 1)\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>