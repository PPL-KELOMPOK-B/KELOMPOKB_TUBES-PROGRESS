    ...
    <style>
        ...
        * {
        ...
        .custom-select-trigger.active {
            border-color: var(--primary);
            box-shadow: 0 0 0 3px rgba(99, 164, 217, 0.1);
        }
        ...
        .icon-warning { background-color: #ecfdf5; color: #10b981; }
        .icon-danger { background-color: #fff7ed; color: #f97316; }
        .icon-critical { background-color: #fef2f2; color: #ef4444; }
        ...
        .dot-warning { background-color: #10b981; box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.1); }
        .dot-danger { background-color: #f97316; box-shadow: 0 0 0 3px rgba(249, 115, 22, 0.1); }
        .dot-critical { background-color: #ef4444; box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.1); }
        ...
        .custom-option.selected .selected-icon {
            opacity: 1;
        }
...
<body>
    ...
    <aside class="sidebar">
        <div class="brand" style="margin-bottom: 24px; padding: 0;">
            <img src="<?php echo e(asset('images/logo-gwm.png')); ?>" alt="GWM Logo" style="width: 100%; max-height: 80px; object-fit: contain;">
        </div>
        ...
        <div class="profile-container">
            <div class="profile-top">
                ...
                <div class="profile-info">
                    <h4>Petugas</h4>
                    <p><?php echo e(auth()->user()->name ?? 'Petugas Kecamatan'); ?></p>
                </div>
            </div>
            <div class="profile-bottom">
                ...
                <div class="profile-location">
                    ...
                    <strong>Kecamatan <?php echo e(auth()->user()->name ?? 'Gedangsari'); ?></strong>
                </div>
            </div>
        </div>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('petugas.draft')); ?>">
    ...
    <main class="main-content">
        <div class="page-title" style="margin-bottom: 32px;">
            <h1 style="font-size: 24px; color: var(--text-dark);">Form Laporan Kekeringan</h1>
            <p style="font-size: 14px; color: var(--text-gray); margin-top: 4px;">Isi formulir untuk melaporkan kondisi air di desa Anda</p>
        </div>

        <form action="<?php echo e(isset($laporan) ? route('petugas.update_laporan', $laporan->id) : route('petugas.store_laporan')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="card" style="margin-bottom: 24px;">
                ...
                <div style="display: grid; gap: 20px;">
                    <div>
                        ...
                        <input type="text" name="kecamatan" readonly value="<?php echo e(auth()->user()->name ?? 'Purwosari'); ?>" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid var(--border); background-color: #f8fafc; color: var(--text-gray); font-family: inherit; font-size: 14px; outline: none;">
                        <span style="font-size: 11px; color: var(--text-gray); display: block; margin-top: 6px;">Lokasi kecamatan Anda (tidak dapat diubah)</span>
                    </div>
                    
                    <div>
                        <label style="display: block; font-size: 13px; font-weight: 600; color: var(--text-dark); margin-bottom: 8px;">Kelurahan</label>
                        <select name="kelurahan" required style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid <?php echo e($errors->has('kelurahan') ? '#ef4444' : '#cbd5e1'); ?>; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none; appearance: none; cursor: pointer; background-image: url('data:image/svg+xml;utf8,<svg fill=%22none%22 stroke=%22currentColor%22 viewBox=%220 0 24 24%22 xmlns=%22http://www.w3.org/2000/svg%22><path stroke-linecap=%22round%22 stroke-linejoin=%22round%22 stroke-width=%222%22 d=%22M19 9l-7 7-7-7%22></path></svg>'); background-repeat: no-repeat; background-position: right 16px center; background-size: 16px;">
                            <option value="">Pilih Kelurahan</option>
                            <?php $__currentLoopData = $kelurahans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($k) != ''): ?>
                                    <option value="<?php echo e(trim($k)); ?>" <?php echo e((isset($laporan) && $laporan->kelurahan == trim($k)) || old('kelurahan') == trim($k) ? 'selected' : ''); ?>><?php echo e(trim($k)); ?></option>
                                <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span style="font-size: 12px; color: #ef4444; display: block; margin-top: 6px;"><?php echo e($message); ?></span>
                        <?php unset($message);
                ...
                <div style="display: grid; gap: 20px;">
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <input type="hidden" name="kondisi_air" id="kondisi_air_input" value="<?php echo e(old('kondisi_air', $laporan->kondisi_air ?? '')); ?>" required>
                            <div class="custom-select-trigger" id="kondisi_air_trigger">
                                <span id="selected-text">
                                    <?php if(old('kondisi_air', $laporan->kondisi_air ?? '')): ?>
                                        <?php echo e(old('kondisi_air', $laporan->kondisi_air ?? '')); ?>
                            ...
                            <div class="custom-options" id="kondisi_air_options">
                                <!-- Option 1 -->
                                <div class="custom-option <?php echo e(old('kondisi_air', $laporan->kondisi_air ?? '') == 'Ketersediaan air mulai berkurang' ? 'selected' : ''); ?>" data-value="Ketersediaan air mulai berkurang">
                                    ...
                                    <div class="option-content">
                                        <div class="option-header">
                                            ...
                                            <span class="option-title">Ketersediaan air mulai berkurang</span>
                                        </div>
                                        <span class="option-desc">Penurunan debit air terlihat jelas, waktu pengisian wadah/toren 2x lebih lama, sumber air mulai surut namun masih mengalir.</span>
                                    </div>
                                ...
                                <!-- Option 2 -->
                                <div class="custom-option <?php echo e(old('kondisi_air', $laporan->kondisi_air ?? '') == 'Ketersediaan air tidak mencukupi' ? 'selected' : ''); ?>" data-value="Ketersediaan air tidak mencukupi">
                                    <div class="option-icon icon-danger">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                                    </div>
                                    <div class="option-content">
                                        <div class="option-header">
                                            <span class="status-dot dot-danger"></span>
                                            <span class="option-title">Ketersediaan air tidak mencukupi</span>
                                        </div>
                                        <span class="option-desc">Air hanya tersedia di jam tertentu, kebutuhan sanitasi seperti mandi atau mencuci terganggu, warga mulai membeli air tangki untuk memenuhi kebutuhan sehari-hari.</span>
                                    </div>
                                    <div class="selected-icon">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                                    </div>
                                ...
                                <!-- Option 3 -->
                                <div class="custom-option <?php echo e(old('kondisi_air', $laporan->kondisi_air ?? '') == 'Air tidak tersedia' ? 'selected' : ''); ?>" data-value="Air tidak tersedia">
                                    <div class="option-icon icon-critical">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line></svg>
                                    </div>
                                    <div class="option-content">
                                        <div class="option-header">
                                            <span class="status-dot dot-critical"></span>
                                            <span class="option-title">Air tidak tersedia</span>
                                        </div>
                                        <span class="option-desc">Sumber air/sumur kering total, kebutuhan pokok seperti air minum sulit dipenuhi, mulai berdampak pada kematian ternak maupun tanaman pangan milik warga.</span>
                                    </div>
                                    <div class="selected-icon">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                const trigger = document.getElementById('kondisi_air_trigger');
                                const options = document.getElementById('kondisi_air_options');
                                const input = document.getElementById('kondisi_air_input');
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div>
                            ...
                            <input type="number" name="warga_terdampak" placeholder="0" required min="1" oninvalid="this.setCustomValidity('Jumlah warga harus lebih dari 0')" oninput="this.setCustomValidity('')" value="<?php echo e(old('warga_terdampak', $laporan->warga_terdampak ?? '')); ?>" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid <?php echo e($errors->has('warga_terdampak') ? '#ef4444' : '#cbd5e1'); ?>; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none;">
                            <?php $__errorArgs = ['warga_terdampak'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi_kekeringan" placeholder="0" required min="1" oninvalid="this.setCustomValidity('Durasi kekeringan harus lebih dari 0')" oninput="this.setCustomValidity('')" value="<?php echo e(old('durasi_kekeringan', $laporan->durasi_kekeringan ?? '')); ?>" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid <?php echo e($errors->has('durasi_kekeringan') ? '#ef4444' : '#cbd5e1'); ?>; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none;">
                            <?php $__errorArgs = ['durasi_kekeringan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <script>
                    ...
                    <?php if(isset($laporan) && $laporan->foto): ?>
                        <?php
                        ...
                        ?>
                        existingFotos = <?php echo json_encode($fotos); ?>;
            ...
            <div class="card" style="margin-bottom: 32px;">
                ...
                <textarea name="keterangan" required rows="4" placeholder="Jelaskan kondisi kekeringan secara detail..." style="width: 100%; padding: 16px; border-radius: 8px; border: 1px solid <?php echo e($errors->has('keterangan') ? '#ef4444' : '#cbd5e1'); ?>; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none; resize: vertical;"><?php echo e(old('keterangan', $laporan->keterangan ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 16px; margin-bottom: 40px;">
                ...
                <button type="submit" name="action" value="preview" style="display: flex; align-items: center; gap: 8px; padding: 12px 24px; background: white; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px; font-weight: 600; color: #1e293b; cursor: pointer; font-family: inherit; transition: all 0.2s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='white'">
...
</html><?php /**PATH C:\Users\Lenovo\gwm_project Update 9 (revisi PBI 1)\resources\views/petugas/create_laporan.blade.php ENDPATH**/ ?>