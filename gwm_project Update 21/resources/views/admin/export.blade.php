        ...
        <div class="export-grid">
            ...
            <div class="settings-card no-print">
                ...
                <div class="form-group">
                    ...
                    @php
                        $earliestDate = $laporans->count() > 0 ? $laporans->last()->created_at->format('Y-m-d') : date('Y-m-d');
                    @endphp
                    <div id="custom-range-inputs" class="custom-range-inputs" style="display: none;">
                        <div>
                            <label for="start-date" style="font-size: 11px; font-weight: 700; color: var(--text-gray); margin-bottom: 6px; display: block;">DARI TANGGAL</label>
                            <input type="date" id="start-date" class="form-input" style="width: 100%; box-sizing: border-box;" placeholder="Mulai" min="{{ $earliestDate }}" max="{{ date('Y-m-d') }}">
                        </div>
                        <div>
                            <label for="end-date" style="font-size: 11px; font-weight: 700; color: var(--text-gray); margin-bottom: 6px; display: block;">SAMPAI TANGGAL</label>
                            <input type="date" id="end-date" class="form-input" style="width: 100%; box-sizing: border-box;" placeholder="Selesai" min="{{ $earliestDate }}" max="{{ date('Y-m-d') }}">
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function toggleSectionsVisibility() {
                secRingkasan.style.display = 'block';
                secLaporan.style.display = 'block';
