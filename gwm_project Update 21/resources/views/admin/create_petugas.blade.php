    ...
    <main class="main-content">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px; max-width: 800px;">
            <div class="chart-card" style="height: auto; max-width: none;">
                ...
                <form id="createPetugasForm" action="{{ route('admin.store_petugas') }}" method="POST"
                    style="display: flex; flex-direction: column; gap: 16px;" novalidate>
                    @csrf
                    <div>
                        <label
