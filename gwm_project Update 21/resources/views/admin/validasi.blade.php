            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th width="10%" style="text-align: center;">Review</th>
                ...
                <tbody>
                    @forelse($laporans as $index => $lap)
                        <tr>
                            ...
                            <td style="font-weight: 600; color: #1e40af;">R{{ str_pad($lap->id, 3, '0', STR_PAD_LEFT) }}</td>
                            <td>
                            ...
                            <td style="text-align: center;">
                                <div class="validasi-actions" style="justify-content: center;">
                                    ...
                                    <form action="{{ route('admin.validasi.destroy', $lap->id) }}" method="POST" class="delete-form" style="margin: 0;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn-delete delete-btn" title="Hapus Laporan">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 32px; color: var(--text-gray);">Tidak ada laporan saat ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
