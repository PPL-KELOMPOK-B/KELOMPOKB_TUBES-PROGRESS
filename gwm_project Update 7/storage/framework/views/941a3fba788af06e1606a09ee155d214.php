...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('petugas.draft')); ?>" class="active">
        ...
        <div class="top-header">
            <div class="page-title">
                ...
                <p>
                    ...
                    Draft laporan Kecamatan <?php echo e(auth()->user()->name ?? 'Purwosari'); ?>

                </p>
            </div>
            <a href="<?php echo e(route('petugas.create_laporan')); ?>" class="btn-primary">
                ...
                <?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $draft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="draft-card">
                        <div class="draft-header">
                            <h3>Kelurahan <?php echo e($draft->kelurahan ?? '-'); ?></h3>
                            <span class="draft-badge">D<?php echo e(str_pad($draft->id, 3, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                        ...
                        <div class="draft-location">
                            ...
                            Kec. <?php echo e($draft->kecamatan); ?>

                        </div>
                        
                        <div class="draft-info">
                            Kondisi: <strong><?php echo e($draft->kondisi_air ?? 'Belum diisi'); ?></strong>
                        </div>
                        <div class="draft-info">
                            Warga terdampak: <strong><?php echo e($draft->warga_terdampak ?? 0); ?> orang</strong>
                        </div>
                        
                        <div class="draft-date">
                            Disimpan: <?php echo e(\Carbon\Carbon::parse($draft->updated_at)->timezone('Asia/Jakarta')->locale('id')->isoFormat('D MMMM YYYY [pukul] HH.mm')); ?> WIB
                        </div>
                        
                        <div class="draft-actions">
                            <a href="<?php echo e(route('petugas.edit_laporan', $draft->id)); ?>" class="btn-edit">
                                <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                Lanjutkan Edit
                            </a>
                            <form action="<?php echo e(route('petugas.delete_laporan', $draft->id)); ?>" method="POST" style="margin: 0;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus draft ini?');">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH E:\TUBES PPL\gwm_project Update 6\resources\views/petugas/draft_laporan.blade.php ENDPATH**/ ?>