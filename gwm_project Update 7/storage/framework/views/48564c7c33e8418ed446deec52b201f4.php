...
<body>
    ...
    <main class="main-content">
        <a href="<?php echo e(route('admin.validasi.index')); ?>" class="btn-back">
        ...
        <div class="document-container">
            <div class="doc-header">
                ...
                <div class="doc-meta">
                    Tanggal: <?php echo e($laporan->created_at->format('d F Y')); ?> <span style="margin: 0 8px; color: #cbd5e1;">|</span> Kecamatan: <?php echo e(str_replace('Petugas ', '', $laporan->kecamatan ?? 'Purwosari')); ?>
            ...
            <div class="info-grid">
                ...
                <div class="info-value">: <?php echo e(str_replace('Petugas ', '', $laporan->kecamatan ?? 'Purwosari')); ?></div>
                <div class="info-label">Kelurahan</div>
                <div class="info-value">: <?php echo e($laporan->kelurahan ?? '-'); ?></div>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-value">
                    : <span class="badge-kritis"><?php echo e($laporan->kondisi_air ?? 'Kritis'); ?></span>
                </div>
                <div class="info-label">Warga Terdampak</div>
                <div class="info-value">: <?php echo e($laporan->warga_terdampak ?? 0); ?> jiwa</div>
                <div class="info-label">Durasi</div>
                <div class="info-value">: <?php echo e($laporan->durasi_kekeringan ?? 0); ?> hari</div>
            </div>
            ...
            <div class="photo-grid">
                <?php if($laporan->foto): ?>
                    ...
                    <?php $__currentLoopData = $fotosArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="photo-card">
                            <img src="<?php echo e(Storage::url($foto)); ?>" alt="Dokumentasi <?php echo e($index + 1); ?>" class="photo-img" onerror="this.src='https://placehold.co/400x300?text=Foto+Tidak+Ditemukan'">
                            <div class="photo-caption">Foto <?php echo e($index + 1); ?></div>
                        </div>
...
<?php /**PATH E:\TUBES PPL\gwm_project Update 6\resources\views/admin/validasi_detail.blade.php ENDPATH**/ ?>