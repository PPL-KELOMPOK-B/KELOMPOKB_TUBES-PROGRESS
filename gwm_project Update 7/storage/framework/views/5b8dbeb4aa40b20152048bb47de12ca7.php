...
<head>
    ...
    <style>
        ...
        * {
        ...
        .level-rendah { background: #dcfce7; color: #15803d; }
        .level-sedang { background: #fef3c7; color: #d97706; }
        .level-tinggi { background: #fee2e2; color: #ef4444; }
        .level-kritis { background: #7f1d1d; color: #fca5a5; }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="profile-container">
            <div class="profile-top">
                ...
                <div class="profile-info">
                    <h4>Petugas</h4>
                    <p><?php echo e(auth()->user()->name ?? 'Budi Santoso'); ?></p>
                </div>
            </div>
            <div class="profile-bottom">
                ...
                <div class="profile-location">
                    ...
                    <strong>Kecamatan Petugas <?php echo e(explode(' ', auth()->user()->name)[1] ?? 'Purwosari'); ?></strong>
                </div>
            </div>
        </div>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('petugas.laporan.index')); ?>" class="active">
    ...
    <main class="main-content">
        <div class="top-header">
            <div class="page-title">
                ...
                <p>
                    ...
                    Menampilkan laporan Kecamatan <?php echo e(explode(' ', auth()->user()->name)[1] ?? 'Purwosari'); ?>

                </p>
            </div>
            <a href="<?php echo e(route('petugas.create_laporan')); ?>" class="btn-add">
        ...
        <form method="GET" action="<?php echo e(route('petugas.laporan.index')); ?>" class="filter-section">
            <div class="search-box">
                ...
                <input type="text" name="search" placeholder="Cari lokasi..." value="<?php echo e(request('search')); ?>">
            </div>
            <div class="filter-box">
                ...
                <select name="status" onchange="this.form.submit()">
                    <option value="Semua Status" <?php echo e(request('status') == 'Semua Status' ? 'selected' : ''); ?>>Semua Status</option>
                    <option value="Menunggu Validasi" <?php echo e(request('status') == 'Menunggu Validasi' ? 'selected' : ''); ?>>Menunggu Validasi</option>
                    <option value="Proses" <?php echo e(request('status') == 'Proses' ? 'selected' : ''); ?>>Sedang Diproses</option>
            ...
            <div class="report-list">
                <?php $__currentLoopData = $laporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        ...
                        if ($lap->kondisi_air == 'Ketersediaan air mulai berkurang' || $lap->kondisi_air == 'Waspada' || stripos($lap->kondisi_air, 'kurang') !== false) {
                            $level = 'Sedang';
                            $levelClass = 'level-sedang';
                        } elseif ($lap->kondisi_air == 'Ketersediaan air tidak mencukupi' || $lap->kondisi_air == 'Siaga' || stripos($lap->kondisi_air, 'tidak cukup') !== false) {
                            $level = 'Tinggi';
                            $levelClass = 'level-tinggi';
                        } elseif ($lap->kondisi_air == 'Air tidak tersedia' || $lap->kondisi_air == 'Kritis' || stripos($lap->kondisi_air, 'kritis') !== false) {
                            $level = 'Kritis';
                            $levelClass = 'level-kritis';
                        }
                        
                        // Calculate progress
                        $progress = 30; // default for menunggu_validasi
                        $progressColor = '#2b567a'; // default blue
                        if ($lap->status == 'diterima' || $lap->status == 'proses' || $lap->status == 'diproses') $progress = 60;
                        ...
                        if ($lap->status == 'ditolak') {
                            $progress = 100;
                            $progressColor = '#ef4444'; // red for rejected
                        }
                    ?>
                    ...
                    <div class="report-card">
                        <div class="report-top">
                            <div class="report-badges">
                                <span class="badge-id">R<?php echo e(str_pad($lap->id, 3, '0', STR_PAD_LEFT)); ?></span>
                                <span class="badge-status status-<?php echo e($lap->status); ?>">
                                    <?php if($lap->status == 'menunggu_validasi'): ?>
                                        Menunggu Validasi
                                    <?php elseif($lap->status == 'proses'): ?>
                                        Sedang Diproses
                                    <?php else: ?>
                                        <?php echo e(ucfirst($lap->status)); ?>

                                    <?php endif; ?>
                                </span>
                                <span class="badge-level <?php echo e($levelClass); ?>"><?php echo e($level); ?></span>
                            </div>
                        ...
                        <h3 class="report-title">Kelurahan <?php echo e($lap->kelurahan); ?></h3>
                        ...
                        <div class="report-location">
                            ...
                            Kec. <?php echo e(str_replace('Petugas ', '', $lap->kecamatan ?? (explode(' ', auth()->user()->name)[1] ?? 'Purwosari'))); ?>

                        </div>
                        
                        <p class="report-meta">
                            <?php echo e($lap->warga_terdampak); ?> warga terdampak - <?php echo e($lap->durasi_kekeringan); ?> hari kekeringan
                        </p>
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress-bar-bg">
                                <div class="progress-bar-fill" style="width: <?php echo e($progress); ?>%; background-color: <?php echo e($progressColor); ?>;"></div>
                            </div>
                            <div class="progress-labels-bottom">
                                <span>Validasi</span>
                                <span>Proses</span>
                                <span><?php echo e($lap->status == 'ditolak' ? 'Ditolak' : 'Selesai'); ?></span>
                            </div>
                        </div>

                        
                        <div class="report-actions">
                            <a href="<?php echo e(route('petugas.show_laporan', $lap->id)); ?>" class="btn-detail">
                            ...
                            <?php if($lap->isEditable()): ?>
                                <a href="<?php echo e(route('petugas.edit_laporan_list', $lap->id)); ?>" class="btn-edit-laporan">
...
<?php /**PATH E:\TUBES PPL\gwm_project Update 6\resources\views/petugas/laporan.blade.php ENDPATH**/ ?>