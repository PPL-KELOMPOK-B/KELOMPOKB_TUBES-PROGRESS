...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.create_petugas')); ?>" class="nav-link">
                    <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor">
    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-value"><?php echo e($total); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-value"><?php echo e($kritis); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <div>
                        <span class="stat-value"><?php echo e(number_format($warga_terdampak)); ?></span>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-value"><?php echo e($tervalidasi); ?></span>
                </div>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <span class="stat-value"><?php echo e($tidak_tervalidasi ?? 0); ?></span>
                </div>
                <div class="stat-icon icon-red">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="distribusi-section">
            ...
            <div class="distribusi-card">
                ...
                <div class="chart-legend">
                    <div class="legend-item">
                        ...
                        Rendah: <?php echo e($rendah ?? 0); ?>

                    </div>
                    <div class="legend-item">
                        <span class="legend-dot" style="background: #eab308;"></span>
                        Sedang: <?php echo e($sedang ?? 0); ?>

                    </div>
                    <div class="legend-item">
                        <span class="legend-dot" style="background: #f97316;"></span>
                        Tinggi: <?php echo e($tinggi ?? 0); ?>

                    </div>
                    <div class="legend-item">
                        <span class="legend-dot" style="background: #ef4444;"></span>
                        Kritis: <?php echo e($kritis ?? 0); ?>
            ...
            <div class="distribusi-card">
                ...
                <div class="keterangan-list">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $desaRanking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="keterangan-item status-<?php echo e($item->tipe); ?>">
                            <div class="keterangan-rank rank-<?php echo e($item->tipe); ?>">#<?php echo e($index + 1); ?></div>
                            <div class="keterangan-content">
                                <div class="keterangan-header">
                                    <span class="keterangan-desa">Desa <?php echo e($item->kelurahan); ?></span>
                                    <span class="keterangan-badge badge-<?php echo e($item->tipe); ?>"><?php echo e($item->status_text); ?></span>
                                </div>
                                <div class="keterangan-meta"><?php echo e($item->warna_text); ?>: <?php echo e($item->status_text); ?> · <?php echo e(number_format($item->warga_terdampak)); ?> Warga Terdampak</div>
                                <div class="keterangan-desc"><?php echo e($item->desc); ?></div>
                            </div>
                        </div>
        ...
        <div class="monitoring-section">
            ...
            <?php if($laporanPrioritas->count() > 0): ?>
                <div class="report-list">
                    <?php $__currentLoopData = $laporanPrioritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="report-card <?php echo e(strtolower($laporan->tingkat_kekeringan)); ?>">
                            <div class="report-info">
                                <div class="report-meta">
                                    <span class="report-code"><?php echo e($laporan->kode); ?></span>
                                    <span class="badge badge-<?php echo e(strtolower($laporan->tingkat_kekeringan)); ?>">
                                        <?php echo e($laporan->tingkat_kekeringan); ?>

                                    </span>
                                </div>
                                <div class="report-location">
                                    Desa <?php echo e($laporan->kelurahan); ?>, <?php echo e(str_replace('Petugas ', '', $laporan->kecamatan)); ?>

                                </div>
                                <div class="report-stats">
                                    <?php echo e(number_format($laporan->warga_terdampak)); ?> warga terdampak · <?php echo e($laporan->durasi_kekeringan); ?> hari
                                </div>
                            </div>
                            <div class="report-actions">
                                <a href="<?php echo e('#'); ?>" class="btn-detail" id="btn-kekeringan-<?php echo e($laporan->id); ?>">
                                    <span>Detail</span>
                                    Tingkat Kekeringan
                                </a>
                                <a href="<?php echo e('#'); ?>" class="btn-detail" id="btn-kondisi-<?php echo e($laporan->id); ?>">
                                    <span>Detail</span>
                                    Level Kondisi
                                </a>
                            </div>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e(($rendah ?? 0) == 0 && ($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($rendah ?? 0)); ?>,
                        <?php echo e(($rendah ?? 0) == 0 && ($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($sedang ?? 0)); ?>,
                        <?php echo e(($rendah ?? 0) == 0 && ($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($tinggi ?? 0)); ?>,
                        <?php echo e(($rendah ?? 0) == 0 && ($sedang ?? 0) == 0 && ($tinggi ?? 0) == 0 && ($kritis ?? 0) == 0 ? 1 : ($kritis ?? 0)); ?>
...
<?php /**PATH E:\TUBES PPL\gwm_project Update 6\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>