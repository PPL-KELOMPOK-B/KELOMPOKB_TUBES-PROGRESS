...
<body>
            ...
            <div class="chart-card">
                <div class="chart-card-header">
                    <h3 class="chart-card-title">
                        ...
                        Tren Tingkat Kekeringan Bulanan
                    </h3>
                </div>
                ...
                <div class="line-legend">
                    <span><span class="legend-marker" style="background-color: #ef4444;"></span>Kritis (4)</span>
                    <span><span class="legend-marker" style="background-color: #f97316;"></span>Tinggi (3)</span>
                    <span><span class="legend-marker" style="background-color: #eab308;"></span>Sedang (2)</span>
                    <span><span class="legend-marker" style="background-color: #10b981;"></span>Rendah (1)</span>
                </div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="chart-wrapper">
                    ...
                    <div class="doughnut-center-info">
                        <span class="doughnut-center-number">{{ $wilayahKritisCount + $wilayahTinggiCount + $wilayahSedangCount }}</span>
                        <span class="doughnut-center-label">Wilayah</span>
                    </div>
                </div>
                <div class="line-legend">
        ...
        <div class="full-width-chart">
            <div class="chart-card-header">
                <h3 class="chart-card-title">
                    ...
                    Dampak Kekeringan: Sebaran Jiwa Terdampak per Kelurahan
                </h3>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            trendGradient.addColorStop(1, 'rgba(16, 185, 129, 0.00)');

            const rawTrendData = @json($monthlyTrendData);
            const pointColors = rawTrendData.map(val => {
                if (val >= 3.5) return colors.kritis;
                if (val >= 2.5) return colors.tinggi;
                if (val >= 1.5) return colors.sedang;
            ...
            new Chart(trendCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Indeks Kekeringan',
                        data: rawTrendData,
                        borderColor: colors.rendah,
                        borderWidth: 3,
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: function(context) {
                                    ...
                                    let levelStr = 'Aman';
                                    if (value >= 3.5) levelStr = 'Kritis';
                                    else if (value >= 2.5) levelStr = 'Tinggi';
                                    else if (value >= 1.5) levelStr = 'Sedang';
                                    else if (value >= 0.5) levelStr = 'Rendah';
                                    return `Indeks: ${value} (${levelStr})`;
                                }
                            }
                        }
                    },
                        ...
                        y: {
                            ...
                            ticks: {
                                ...
                                callback: function(value) {
                                    const labels = ['Aman', 'Rendah', 'Sedang', 'Tinggi', 'Kritis'];
