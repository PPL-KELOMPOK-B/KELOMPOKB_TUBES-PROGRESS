                ...
                <div style="display: grid; gap: 20px;">
                    <div>
                        ...
                        <div class="custom-select-wrapper">
                            <input type="hidden" name="kondisi_air" id="kondisi_air_input" value="{{ old('kondisi_air', $laporan->kondisi_air ?? '') }}" required>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi_kekeringan" placeholder="0" required min="1" oninvalid="this.setCustomValidity('Durasi kekeringan harus lebih dari 0')" oninput="this.setCustomValidity('')" value="{{ old('durasi_kekeringan', $laporan->durasi_kekeringan ?? '') }}" style="width: 100%; padding: 12px 16px; border-radius: 8px; border: 1px solid {{ $errors->has('durasi_kekeringan') ? '#ef4444' : '#cbd5e1' }}; background-color: white; color: var(--text-dark); font-family: inherit; font-size: 14px; outline: none;">
