...
class DashboardController extends Controller
{
    ...
    public function adminIndex()
    {
        ...
        $data['laporanPrioritas'] = $laporanPrioritas->sortByDesc('skor_prioritas')->take(10);

        // Keterangan Ranking (4 tertinggi)
        $data['desaRanking'] = $laporanPrioritas->sortByDesc('skor_prioritas')->take(4);
    ...
    public function adminTindakLanjut()
    {
        if (auth()->user()->role !== 'admin') abort(403);

        // Ambil aksi tindak lanjut beserta laporannya
        $tindakLanjuts = \App\Models\TindakLanjut::with('laporan')->orderBy('created_at', 'desc')->get();
        ...
        // Saring agar laporan yang sudah ada di daftar tindak lanjut tidak muncul lagi
        ...
        return view('admin.tindak_lanjut', compact('tindakLanjuts', 'laporansReady'));
    }
