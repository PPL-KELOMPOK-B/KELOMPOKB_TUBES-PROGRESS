...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/admin/validasi', [DashboardController::class, 'validasiIndex'])->name('admin.validasi');
    Route::post('/admin/validasi/{id}/approve', [DashboardController::class, 'approveLaporan'])->name('admin.approve_laporan');
    Route::post('/admin/validasi/{id}/reject', [DashboardController::class, 'rejectLaporan'])->name('admin.reject_laporan');
    Route::get('/admin/validasi/{id}/view', [DashboardController::class, 'viewLaporan'])->name('admin.view_laporan');
    
    // Petugas Routes
    Route::get('/petugas/dashboard', [DashboardController::class, 'petugasIndex'])->name('petugas.dashboard');
    Route::get('/petugas/laporan', [DashboardController::class, 'daftarLaporan'])->name('petugas.daftar_laporan');
