...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('petugas.create_laporan') }}">
        ...
        <div class="top-header">
            <div class="page-title">
                ...
                <p>
                    ...
                    Draft laporan Kec. {{ auth()->user()->kecamatan->nama_kecamatan ?? 'Purwosari' }}
                </p>
            </div>
                ...
                @foreach($drafts as $draft)
                    <div class="draft-card">
                        <div class="draft-header">
                            <h3>Kelurahan {{ $draft->kelurahan->nama_kelurahan ?? '-' }}</h3>
                        ...
                        <div class="draft-location">
                            ...
                            Kec. {{ $draft->kecamatan->nama_kecamatan ?? '-' }}
                        </div>
                        
                        <div class="draft-info">
                            Kondisi: <strong>{{ ucfirst($draft->kondisi_air ?? 'Belum diisi') }}</strong>
                        </div>
                        <div class="draft-info">
                            Warga terdampak: <strong>{{ $draft->jumlah_terdampak ?? 0 }} orang</strong>
                        </div>
