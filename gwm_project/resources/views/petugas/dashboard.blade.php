...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('petugas.daftar_laporan') }}">
    ...
    <main class="main-content">
        <div class="top-header">
            <div class="page-title">
                <h1>Dashboard</h1>
                <p>Selamat datang kembali, {{ auth()->user()->nama ?? 'Budi Santoso' }}</p>
            </div>
            <div class="top-pill">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                ...
                Kec. {{ auth()->user()->kecamatan->nama_kecamatan ?? 'Purwosari' }}
            </div>
        </div>
        ...
        <div class="middle-grid">
            ...
            <div class="card">
                ...
                <div class="actions-list">
                    ...
                    <a href="{{ route('petugas.daftar_laporan') }}" class="action-btn btn-outline">
                        <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                        Lihat Semua Laporan
                    </a>
                </div>
        ...
        <div class="card">
            <div class="card-header-between">
                ...
                <a href="{{ route('petugas.daftar_laporan') }}" class="link-all">Lihat Semua</a>
            </div>
