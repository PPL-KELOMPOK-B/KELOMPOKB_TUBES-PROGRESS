        ...
        <div style="background: white; border-radius: 12px; padding: 48px; box-shadow: 0 10px 40px rgba(0,0,0,0.03); max-width: 800px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 32px;">
                ...
                <div style="font-size: 12px; color: var(--text-gray);">
                    Tanggal: {{ $laporan->created_at->format('d F Y') }} <span style="margin: 0 8px; color: #cbd5e1;">|</span> Kecamatan: {{ $laporan->kecamatan->nama_kecamatan ?? '-' }}
                </div>
            </div>
            ...
            <div style="margin-bottom: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 12px; font-size: 13px;">
                    ...
                    <div style="font-weight: 600; color: var(--text-dark);">: {{ $laporan->kecamatan->nama_kecamatan ?? '-' }}</div>
                    <div style="color: var(--text-gray);">Kelurahan</div>
                    <div style="font-weight: 600; color: var(--text-dark);">: Kelurahan {{ $laporan->kelurahan->nama_kelurahan ?? '-' }}</div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 32px;">
                ...
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 16px; font-size: 13px; align-items: center;">
                    ...
                    <div>
                        : <span style="display: inline-block; padding: 4px 12px; background: #fee2e2; color: #ef4444; border-radius: 20px; font-size: 11px; font-weight: 600;">{{ ucfirst($laporan->kondisi_air ?? 'kritis') }}</span>
                    </div>
                    <div style="color: var(--text-gray);">Warga Terdampak</div>
                    <div style="font-weight: 700; color: var(--text-dark);">: {{ $laporan->jumlah_terdampak ?? 0 }} jiwa</div>
                    <div style="color: var(--text-gray);">Durasi</div>
                    <div style="font-weight: 700; color: var(--text-dark);">: {{ $laporan->durasi_hari ?? 0 }} hari</div>
                </div>
            </div>
                    ...
                    <div style="display: flex; gap: 16px; flex-wrap: wrap;">
                        @foreach($laporan->fotos as $index => $foto)
                            <div style="border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; width: 200px; background: #f8fafc;">
                                <img src="{{ asset('storage/' . $foto->path_foto) }}" alt="Dokumentasi {{ $index + 1 }}" style="width: 100%; height: 150px; object-fit: cover; display: block;">
