...
<head>
    ...
    <style>
        ...
        * {
        ...
        .left-side::after {
            bottom: -20%; right: -20%; width: 150%; height: 150%;
        ...
        @media (max-width: 900px) {
            ...
            .left-side {
                display: none; /* Hide branding on very small screens or make it smaller */
            }
            .right-side {
                padding: 2rem;
            }
...
<div class="split-layout">
        ...
        <div class="left-content">
            ...
            <div class="features">
                ...
                <div class="feature">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 2l3.09 3.09L19.46 3.8l-1.28 4.29L22 12l-3.82 3.91 1.28 4.29-4.37-1.29L12 22l-3.09-3.09-4.37 1.29 1.28-4.29L2 12l3.82-3.91-1.28-4.29 4.37 1.29L12 2z"/>
    ...
    <div class="right-side">
        <div class="login-container">
            ...
            @if($errors->has('roleError'))
                <div style="background: #fef2f2; color: #ef4444; border: 1px solid #fca5a5; padding: 12px; border-radius: 8px; margin-bottom: 20px; font-size: 14px; font-weight: 500; text-align: center;">
                    {{ $errors->first('roleError') }}
                </div>
            @endif

            @if($errors->has('email') && !$errors->has('roleError'))
                <div style="background: #fef2f2; color: #ef4444; border: 1px solid #fca5a5; padding: 12px; border-radius: 8px; margin-bottom: 20px; font-size: 14px; font-weight: 500; text-align: center;">
                    {{ $errors->first('email') }}
                </div>
            @endif
            ...
            <form action="/login" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="email" name="email" placeholder="petugas(kecamatan)@gmail.com" required>
                    </div>
                </div>
            ...
            <div class="footer">
                © 2024 Gunungkidul Water Monitor.<br>The Fluid Authority.
            </div>
        </div>
    </div>
</div>
